...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut__A_B___Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0cedd7b3f15681b4: (a: number, b: number, c: number, d: number) => void;
