...
export function _dyn_core__ops__function__FnMut__A_B___Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4d5fbdf2fa9ab42e(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut__A_B___Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2bd45cb62ab0b1f4(a: number, b: number, c: number, d: number, e: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc53aeb2093da1c0b(a: number, b: number, c: number): void;
